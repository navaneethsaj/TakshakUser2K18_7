...
public class EventFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        {
            case "mca":
                filename = "mca_event.json";
                break;
            case "ece":
                filename = "ece_event.json";
                break;
            case "eee":
                filename = "eee_event.json";
                break;
            case "mech":
                filename = "mech_event.json";
                break;
            case "cse":
                filename = "cse_event.json";
                break;
            case "core":
                filename = "core_event.json";
                break;
            case "civil":
                filename = "civil_event.json";
                break;
            default:
